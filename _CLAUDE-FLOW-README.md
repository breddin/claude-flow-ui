...
> **🍴 This is a fork of [ruvnet/claude-flow](https://github.com/ruvnet/claude-flow)** maintained by **@breddin**
> 
> **📍 Fork Status**: Based on upstream `alpha-63` branch (v2.0.0-alpha.64+)  
> **🎯 Purpose**: Personal development and testing of claude-flow features  
> **🔄 Sync**: Regularly updated from upstream ruvnet/claude-flow  
> **🆕 Latest**: Merged alpha-63 improvements - SPARC by default, enhanced init, wrapper fixes  

<div align="center">

[![🌟 Star on GitHub](https://img.shields.io/github/stars/ruvnet/claude-flow?style=for-the-badge&logo=github&color=gold)](https://github.com/ruvnet/claude-flow)
[![📦 Alpha Release](https://img.shields.io/npm/v/claude-flow/alpha?style=for-the-badge&logo=npm&color=orange&label=v2.0.0-alpha.64)](https://www.npmjs.com/package/claude-flow/v/alpha)
...
# Verify installation
claude-flow --version  # Should show 2.0.0-alpha.62
```
